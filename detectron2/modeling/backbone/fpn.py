...
class DepthwiseSeparableConvolution(nn.Module):
    def __init__(in_chans, out_chans, bias=use_bias):
        ...
        self.depthwise = Conv2d(
                in_chans, in_chans, kernel_size=3, stride=1, padding=1, bias=bias, groups=in_chans
            )
        self.pointwise = Conv2d(
                in_chans, out_chans, kernel_size=1, stride=1, bias=bias
        )
...
class BIFPN(Backbone):
    ...
    def __init__(
        ...
        assert isinstance(bottom_up, Backbone)
        assert in_features, in_features
        assert num_layers >= 1, "BIFPN error, invalid number of layers."
